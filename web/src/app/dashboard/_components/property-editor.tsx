  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div>
          <label className="mb-1 block text-sm text-white/70">Field Name</label>
          <Input
            value={property.name}
      ...
      <div className="flex justify-end pt-2">
        <Button variant="destructive" onClick={() => onRemove(property.id)}>
          <Trash2 size={16} className="mr-1" /> Remove Field
        </Button>
      </div>
    </div>
  );
                        ...
                        : newType === "boolean"
                          ...
                          : newType === "object"
                            ...
                            : newType === "array"
                              ? []
                              : null;
                  onChange({ ...property, type: newType, value: defaultValue });
                }}
              >
                <SelectTrigger className="border-white/10 bg-white/5 text-white">
                  <SelectValue placeholder="Select type" />
